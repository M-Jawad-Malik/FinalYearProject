...
public class transactionAdapter extends RecyclerView.Adapter<transactionAdapter.myViewHolder>{
    ...
    public transactionAdapter(Context context, ArrayList<com.example.tris.manageExpense.TransactionModel> transactionModelArrayList) {
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, int position) {
        com.example.tris.manageExpense.TransactionModel model = transactionModelArrayList.get(position);
