...
import com.example.tris.databinding.ActivityAddTransactionBinding;
...
//        ************************ ADD Button ***********************
        binding.submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    startActivity(new Intent(AddTransaction.this, com.example.tris.manageExpense.dashBoard.class));
                }catch (Exception e){
