...
import com.example.tris.ads.adapter.SliderAdapter;
import com.example.tris.ads.model.Ads;
import com.example.tris.ads.model.Event;
import com.example.tris.ads.model.Favorite;
...
if(ads!=null&&event==null) {
	...
	private void authenticateCheck() {
		if (FirebaseHelper.getAutentication()) {
			...
			startActivity(new Intent(this, com.example.tris.manageExpense.MainActivity.class));
		}
	}
